...
public class FormattedOutputController {
	...
	@GetMapping(
			  value = "/get-minfile-for-readCodes/{props}/{terms}",
			  produces = MediaType.APPLICATION_OCTET_STREAM_VALUE
			)
			public ResponseEntity<InputStreamResource>  getFileByFormat(@PathVariable String terms,
					@PathVariable String props) {
		            	...
		            	in = (ByteArrayInputStream)
					    		service.produceMinTabDelOutputFromList(terms, null,"match", "0", "10");
