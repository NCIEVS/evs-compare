...
const api = {
	...
	getOptionIncludes(baseUrl){
			console.log('baseUrl == ' + baseUrl);
			return new Promise((resolve)=>{
					axios.get(baseUrl + '/' + 'util/getentityscopetype')
					.then((response) =>{
		...
		getOptionType(baseUrl){
				console.log('baseUrl == ' + baseUrl);
				return new Promise((resolve)=>{
						axios.get(baseUrl + '/' + 'util/querytype')
						.then((response) =>{
						resolve(response.data);
						})
				})
			...
			getOptionTerminologies(baseUrl){
					console.log('baseUrl == ' + baseUrl);
					return new Promise((resolve)=>{
							axios.get(baseUrl + '/' + 'util/terminologies')
							.then((response) =>{
							resolve(response.data);
							})
					})
